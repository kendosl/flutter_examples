...
import 'package:mvvm_with_provider_example_3/pellen/components/row_with_number/numbered_row.component.dart';
...
class _SectionOne extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ColumnSpacer(
      ...
      children: [
        ImageComponent(assetName: model.topSection().first.url),
        ListView.builder(
