...
import 'package:mvvm_with_provider_example_3/fringilla/components/button/button.component.dart';
import 'package:mvvm_with_provider_example_3/fringilla/components/card/card.component.dart';
import 'package:mvvm_with_provider_example_3/fringilla/components/webview/webview.component.dart';
import 'package:mvvm_with_provider_example_3/fringilla/utils/strings.dart';
...
class _FringillaViewState extends State<FringillaView> {
  ...
  void initState() {
    super.initState();
    viewModel =
        Provider.of(context)<FringillaViewModel>(context, listen: false);
          ...
          child: CardComponent(
            onPressed: () {
              navService.nav.push(
                MaterialPageRoute(
                  builder: (_) =>
                      WebViewComponent(url: model.items[i].urlLink!),
                ),
              );
            },
